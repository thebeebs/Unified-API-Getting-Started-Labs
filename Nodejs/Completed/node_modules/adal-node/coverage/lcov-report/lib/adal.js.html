...
<html lang="en">
<head>
    <title>Code coverage report for lib\adal.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\adal.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; adal.js</div>
</div>
<div class="body">
 ...
 */
exports.createAuthenticationContext = <span class="fstat-no" title="function not covered" >function(authority, validateAuthority) {</span>
<span class="cstat-no" title="statement not covered" >  return new ac.AuthenticationContext(authority, validateAuthority);</span>
};
&nbsp;
